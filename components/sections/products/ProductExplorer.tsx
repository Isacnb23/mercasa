...
function FamilyCard({
  ...
  if (compact) {
    // Versión "chica" con la misma jerarquía visual que la tarjeta completa
    // de abajo (ícono grande + nombre + conteo + botón "Ver catálogo"), solo
    // escalada — la primera versión (ícono de 40px + una sola línea de
    // texto de link) se veía demasiado chica y plana al lado del resto de
    // la sección (ver segmentos-familias-espaciado-animacion-boton.md,
